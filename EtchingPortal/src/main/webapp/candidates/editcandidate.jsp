...
<html>
    <head>
        ...
        <title>JobPortal - Edit candidate</title>
    </head>
    <body>
...
you are welcome <strong><s:property value="#session.userName"/></strong>
                <ul>
                    <li><s:a href="../index.jsp">
Return to index</s:a></li>
        ...
        <main>
            ...
            <s:form action="editCandidate" class="com.EtchingPortal.web.CandidateAction">
